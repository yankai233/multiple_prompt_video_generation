...
class Args(BaseModel):
    ...
    training_type: Literal["lora", "sft", "all"] = "all"

    feature_extractor_config: str = '../configs/feature_extractor.yaml'
    feature_extractor_ckpt: str = r'E:\PythonLearn\work\SSH_Connect\Autodl\under2postgraudate\Video-Generation-field\Ours\Multiple scene\Mutiple_prompt_mutiple_scene\excluded_dir\output_dir\logs\1\ckpt\feature_extraction_model_last.pth'
    ...
    def parse_args(cls):
        ...
        # load model
        parser.add_argument('--feature_extractor_config', type=str, default='../configs/feature_extractor.yaml')
        parser.add_argument('--feature_extractor_ckpt', type=str, default=r'E:\PythonLearn\work\SSH_Connect\Autodl\under2postgraudate\Video-Generation-field\Ours\Multiple scene\Mutiple_prompt_mutiple_scene\excluded_dir\output_dir\logs\1\ckpt\feature_extraction_model_last.pth')
