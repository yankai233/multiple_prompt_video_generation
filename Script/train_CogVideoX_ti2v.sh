...
# Model Configuration
MODEL_ARGS=(
    --model_path "E:/PythonLearn/work/SSH_Connect/Autodl/under2postgraudate/Video-Generation-field/Ours/Multiple scene/excluded_dir/local_model/model_dir"
    --model_name "text_model"  # ["cogvideox-t2v"]
    --model_type "multi_ti2v"
    --training_type "all"

    --feature_extractor_config "E:/PythonLearn/work/SSH_Connect/Autodl/under2postgraudate/Video-Generation-field/Ours/Multiple scene/excluded_dir/output_dir/logs/1/ckpt/config.yaml"
    --feature_extractor_ckpt "E:/PythonLearn/work/SSH_Connect/Autodl/under2postgraudate/Video-Generation-field/Ours/Multiple scene/excluded_dir/local_model/model_dir/feature_extractor/feature_extraction_model_last.pth"
)

# Output Configuration
OUTPUT_ARGS=(
    --output_dir "E:/PythonLearn/work/SSH_Connect/Autodl/under2postgraudate/Video-Generation-field/Ours/Multiple scene/excluded_dir/output_dir/logs/2"
    --report_to "tensorboard"
)

# Data Configuration
DATA_ARGS=(
    --data_root "E:/PythonLearn/work/SSH_Connect/Autodl/under2postgraudate/Video-Generation-field/Ours/Multiple scene/excluded_dir/dataset"    # root path
    --train_resolution "49x768x1360"  # (frames x height x width), frames should be 8N+1
...
accelerate launch train_CogVideoX.py \
    "${MODEL_ARGS[@]}" \
    "${OUTPUT_ARGS[@]}" \
    "${DATA_ARGS[@]}" \
    "${TRAIN_ARGS[@]}" \
